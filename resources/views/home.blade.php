      ...
      <div class="container container--flex">
        ...
        <nav class="main-nav">
          ...
          <ul class="menu" id="menu">
              <li class="menu__item"><a href="{{route('login')}}" class="menu__link"><span>Oturum Aç</span></a></li>
              <li class="menu__item"><a href="{{route('registration')}}" class="menu__link"><span>Kaydol</span></a></li>
      ...
      <div class="container">
        ...
        <div class="column column--50-25">
          ...
          <div class="contact-icon">
            ...
            <p class="contact__txt">Kavaklıdere Mahallesi, Atatürk Bulvarı, No:123, Çankaya, Ankara</p>
          </div>
          <div class="contact-icon">
